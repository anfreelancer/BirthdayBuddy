...
import com.luteapp.birthdaybuddy.BillingClientSetup
import com.luteapp.birthdaybuddy.MainActivity
import com.luteapp.birthdaybuddy.R
import com.luteapp.birthdaybuddy.ShopActivity
import com.luteapp.birthdaybuddy.handler.EventHandler
import com.luteapp.birthdaybuddy.views.EventAdapter
...
class EventListFragment : Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu?, inflater: MenuInflater?) {
        ...
        (menu?.findItem(R.id.toolbar_search)?.actionView as androidx.appcompat.widget.SearchView).apply {
